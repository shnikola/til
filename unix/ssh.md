...
`rsync /local/directory app@shitake:/remote/directory` kopira direktorij na lokalni stroj, ali je brži jer ne kopira postojeće fileove. Odlično za sinkroniziranje direktorija.
`-nv` ne kopira ništa nego ispisuje što bi se sve kopiralo. Korisno prije stvarnog poziva.
